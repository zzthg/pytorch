...
can_use_flash_attention = torch._dynamo.allow_in_graph(can_use_flash_attention)
can_use_efficient_attention = torch._dynamo.allow_in_graph(can_use_efficient_attention)

...
void ProcessGroupNCCL::waitForPendingWorks() {
  ...
  // 1. waitForPendingWorks should be called after user code finished calling
  //    collectives. This means, when we got here, all of the collectives are

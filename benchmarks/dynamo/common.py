...
def speedup_experiment_onnx(
    ...
    **kwargs,
    ...
    onnx_model = onnx_model_cls(
        args.output_directory or ".", model, copy.deepcopy(example_inputs), dynamic_shapes=args.dynamic_shapes
    )
    ...
    def run_n_iterations_onnx(model, inputs, n=2):
        ...
        try:
            ...
            if onnx_model is None:
                onnx_model = onnx_model_cls(
                    output_directory, model, copy.deepcopy(inputs), dynamic_shapes=dynamic_shapes
                )
...
def run(runner, args, original_dir=None):
    ...
    if args.overhead:
        ...
        optimize_ctx = functools.partial(
            optimize_onnx_ctx, args.output_directory or ".", OnnxModelFromDynamo, dynamic_shapes=args.dynamic_shapes
        )

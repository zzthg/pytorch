...
if(INTERN_BUILD_ATEN_OPS)
  ...
  if(CXX_SVE_FOUND)
    ...
    if(CXX_SVE256_FOUND)
      ...
      if("${CXX_SVE256_FLAGS}" STREQUAL "")
        list(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG} -O2 -DCPU_CAPABILITY_SVE")
      else()
        list(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG} -O2 -DCPU_CAPABILITY_SVE ${CXX_SVE256_FLAGS}")
      endif()
    endif()
  endif()
